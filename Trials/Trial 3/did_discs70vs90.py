...
with open('DISCS-desert-island-discs-OnlyNeededFields_OpenRefined-1970s_vs_1990s.csv','r',encoding='utf-8-sig') as networkFile: #Whatever your file is called
...
#Export to CSV
with open("vertices_artist70vs90.csv",'w') as csvfile1:
	csvwriter = csv.writer(csvfile1)
	csvwriter.writerows(vertices)

with open("edges_artist70vs90.csv",'w') as csvfile2:
