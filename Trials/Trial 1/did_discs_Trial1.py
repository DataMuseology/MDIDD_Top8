...
with open('DISCS-desert-island-discs-OnlyNeededFields_OpenRefined.csv','r',encoding='utf-8-sig') as networkFile: #Whatever your file is called
...
#Export to CSV
with open("vertices_whole.csv",'w') as csvfile1:
	csvwriter = csv.writer(csvfile1)
	csvwriter.writerows(vertices)

with open("edges_whole.csv",'w') as csvfile2:
