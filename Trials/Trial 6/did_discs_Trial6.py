...
with open('26260_DISCS-desert-island-discs-OnlyNeededFields-Top8AcrossDataset.csv','r',encoding='utf-8-sig') as networkFile: #Whatever your file is called
...
#Export to CSV
with open("vertices_trial6date.csv",'w') as csvfile1:
	csvwriter = csv.writer(csvfile1)
	csvwriter.writerows(vertices)

with open("edges_trial6date.csv",'w') as csvfile2:
